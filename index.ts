...
class RBTree {
    ...
    private nodeSearched(nodo: NodeRBT, search: number): void {
        if (nodo != this.leaf){
            if (nodo.getData() > search){
                this.nodeSearched(nodo.getLeftChild(), search)
            }
            
            if (nodo.getData() < search){
                this.nodeSearched(nodo.getRightChild(), search)
            }
    ...
    public searchNode(search: number): void {
        this.nodeSearched(this.root, search);
    }
...
myRBTree.insert(50);
myRBTree.insert(45);
console.log("Inorder de forma ascendente:\n");
myRBTree.printInorder();
console.log("\nBusqueda de un numero:\n");
myRBTree.searchNode(15);
myRBTree.searchNode(10);
myRBTree.searchNode(50);
myRBTree.searchNode(7);
myRBTree.searchNode(12);
myRBTree.searchNode(25);
